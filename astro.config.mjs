        ...
        ...(process.env.ENABLE_LINK_CHECKER
          ? [
              starlightLinksValidator({
                // starlight-links-validator does not understand the routes
                // generated by starlight-versions (it registers versioned
                // pages under doubled paths), so every link *targeting* a
                // versioned page is a false positive. Exclude versioned
                // targets so the validator reliably checks the current docs.
                exclude: ["/ts-sdk/[0-9]*.x/**", "/http-api/[0-9]*.x/**"],
              }),
            ]
          : []),
        starlightDocSearch({
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                { slug: "ts-sdk/inputs/moq-server" },
                { slug: "ts-sdk/inputs/moq-client" },
            ...
            },
            {
              ...
              items: [
                ...
                { slug: "ts-sdk/outputs/moq-client" },
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                { slug: "http-api/inputs/moq-server" },
                { slug: "http-api/inputs/moq-client" },
            ...
            },
            {
              ...
              items: [
                ...
                { slug: "http-api/outputs/moq-client" },
                {
                  label: "Encoders",
                  collapsed: true,

---
title: WHEP server
slug: http-api/0.5.x/http-api/outputs/whep
---
...
To connect new output, register it first with [`register-output` request](/http-api/0.5.x/routes#register-output)

...
slug: http-api/0.5.x/http-api/routes
---
...
* [RTMP](/http-api/0.5.x/inputs/rtmp)
...
Register an image asset. Request body is defined in the [image](/http-api/0.5.x/resources/image) docs.
...
Register a shader. Request body is defined in the [shader](/http-api/0.5.x/resources/shader) docs.
...
Register a web renderer instance. Request body is defined in the [web renderer](/http-api/0.5.x/resources/web-renderer) docs.
...
start using new fonts with a [`Text`](/http-api/0.5.x/components/text) component.
...
Establish WebSocket connection to listen for Smelter events. List of supported events and their descriptions can be found [here](/http-api/0.5.x/events).

---
title: InputStream
slug: http-api/0.5.x/http-api/components/inputstream
---
...
<Aside> To use this component, you need to first register the stream with matching `input_id` using [`register input`](/http-api/0.5.x/routes#register-input) request. </Aside>

---
title: WebView
slug: http-api/0.5.x/http-api/components/webview
---

import { Aside, Badge } from '@astrojs/starlight/components';
import CollapsibleDetails from '@components/CollapsibleDetails.astro';

<Badge text="Required feature:web-renderer" variant="note" size="large" />
...
<Aside>To use this component, you need to first register the image with a matching `instance_id` using the [`register web renderer`](/http-api/0.5.x/routes/#register-web-renderer-instance) function.</Aside>
...
[`register web renderer`](/http-api/0.5.x/routes#register-web-renderer-instance) request.

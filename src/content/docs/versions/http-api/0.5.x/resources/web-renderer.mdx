---
title: WebRenderer
slug: http-api/0.5.x/http-api/resources/web-renderer
---
...
Represents an instance of a website rendered using Chromium embedded in the Smelter instance. It is utilized by a [WebView](/http-api/0.5.x/components/webview) component. Ensure that the Smelter supports web rendering before utilizing the web renderer.

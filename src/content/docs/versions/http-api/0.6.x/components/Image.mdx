---
title: Image
slug: http-api/0.6.x/http-api/components/image
---
...
<Aside> To use this component, you need to first register the image with matching `image_id` using [`register image`](/http-api/0.6.x/routes#register-image) request. </Aside>
...
ID of an image. It identifies an image registered using a [register image](/http-api/0.6.x/routes#register-image) request.

---
title: RTMP server
slug: http-api/0.6.x/http-api/inputs/rtmp
---
...
Smelter exposes an RTMP endpoint after you register the input by sending a [`register-input` request](/http-api/0.6.x/routes#register-input).
...
See [HTTP Routes](/http-api/0.6.x/routes#inputs-configuration) documentation to learn more about managing inputs.

...
sidebar:
  order: 2
slug: http-api/0.6.x/http-api/guides/transitions
---
...
In this guide, you will learn how to implement basic animated transitions to the [`View`](/http-api/0.6.x/components/view) and [`Rescaler`](/http-api/0.6.x/components/rescaler) components.

### Basic setup

Start Smelter server, register inputs (`input_1`, `input_2`, `input_3`, `input_4`) and register video output (`output_1`) similarly to examples shown in [`Quick start`](/http-api/0.6.x/guides/quick-start) guide.

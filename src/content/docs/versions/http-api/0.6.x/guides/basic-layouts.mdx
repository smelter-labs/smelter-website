...
sidebar:
  order: 1
slug: http-api/0.6.x/http-api/guides/basic-layouts
---
...
<Steps>
  1. Init Smelter and connect inputs and outputs
     ...
     Start Smelter server, register inputs (`input_1`, `input_2`) and register video output (`output_1`) similarly to examples shown in [`Quick start`](/http-api/0.6.x/guides/quick-start) guide.

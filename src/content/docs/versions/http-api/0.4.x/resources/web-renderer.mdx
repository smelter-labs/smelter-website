...
<Aside>
  You need to enable
  [`SMELTER_WEB_RENDERER_ENABLE`](/http-api/0.4.x/deployment/configuration#smelter_web_renderer_enable)
...
* [`SMELTER_WEB_RENDERER_ENABLE`](/http-api/0.4.x/deployment/configuration#smelter_web_renderer_enable) (default: `false`) - Enables web rendering capabilities.
* [`SMELTER_WEB_RENDERER_GPU_ENABLE`](/http-api/0.4.x/deployment/configuration#smelter_web_renderer_gpu_enable) (default: `true`) - If enabled, websites are rendered on GPU. Otherwise, software based rendering is used.

---
title: WHIP
slug: http-api/0.4.x/http-api/inputs/whip
---
...
configured with [`SMELTER_WHIP_WHEP_SERVER_PORT`](/http-api/0.4.x/deployment/configuration#smelter_whip_whep_server_port).

To connect new input, register it first with [`register-input` request](/http-api/0.4.x/routes#register-input)
...
* **Type**: [`InputWhipVideoOptions`](/http-api/0.4.x/inputs/whip#inputwhipvideooptions)
...
* **Type**: [`InputWhipAudioOptions`](/http-api/0.4.x/inputs/whip#inputwhipaudiooptions)

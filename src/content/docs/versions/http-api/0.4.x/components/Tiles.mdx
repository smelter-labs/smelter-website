---
title: Tiles
slug: http-api/0.4.x/http-api/components/tiles
---
...
<Aside type="caution">
  ...
  component](/http-api/0.4.x/fundamentals/concepts/layouts), the `width` property is
  **required**. - **Layout parent** - For parents that are [layout
  components](/http-api/0.4.x/fundamentals/concepts/layouts), please refer to the relevant
...
<Aside type="caution">
  The behavior of the `Tiles` component varies depending on the type of its
  parent component: - **Non-layout parent** - When the parent is not a [layout
  component](/http-api/0.4.x/fundamentals/concepts/layouts), the `height` property is
  **required**. - **Layout parent** - For parents that are [layout
  components](/http-api/0.4.x/fundamentals/concepts/layouts), please refer to the relevant
  component documentation.
</Aside>

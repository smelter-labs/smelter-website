---
title: Shader
slug: http-api/0.4.x/http-api/components/shader
---
...
For more information on using shaders in Smelter, please visit [Shaders documentation](/http-api/0.4.x/fundamentals/concepts/shaders).

<Aside>
  {" "}

  To use this component, you need to first register the shader with matching `shader_id`
  using [`register shader`](/http-api/0.4.x/routes#register-shader) request.{" "}
</Aside>
...
ID of a shader. It identifies a shader registered using a [register shader](/http-api/0.4.x/routes#register-shader) method.

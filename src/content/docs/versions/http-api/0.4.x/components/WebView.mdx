---
title: WebView
slug: http-api/0.4.x/http-api/components/webview
---
...
<Aside>
  ...
  `instance_id` using the [`register web
    renderer`](/http-api/0.4.x/routes/#register-web-renderer-instance) function.
</Aside>
...
[`register web renderer`](/http-api/0.4.x/routes#register-web-renderer-instance) request.

...
* [`LocallySpawnedInstnaceManager`](/ts-sdk/1.0/ts-sdk/managers/node-locally-spawned) (**default**) - Automatically download the necessary Smelter binaries and launch the server on your local machine.
* [`ExistingInstanceManager`](/ts-sdk/1.0/ts-sdk/managers/node-existing-instance) - Connect to a smelter server instance that is already running.

<br />

* **Type**: [`SmelterManager`](/ts-sdk/1.0/ts-sdk/smelter#runtime-nodejs)
...
See [WebWasmSmelterOptions](/ts-sdk/1.0/ts-sdk/managers/web-wasm/#webwasmsmelteroptions) to learn more.
...
Register an image asset. See [RegisterImage](/ts-sdk/1.0/ts-sdk/resources/image) to learn more.
...
Register a shader. See [RegisterShader](/ts-sdk/1.0/ts-sdk/resources/shader) to learn more.
...
Register a web renderer instance. See [RegisterWebRenderer](/ts-sdk/1.0/ts-sdk/resources/web-renderer) to learn more.

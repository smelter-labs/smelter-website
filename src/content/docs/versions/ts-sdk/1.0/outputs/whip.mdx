...
sidebar:
  order: 1
slug: ts-sdk/1.0/ts-sdk/outputs/whip
---
...
* **Type**: [`WhipVideoOptions`](/ts-sdk/1.0/ts-sdk/outputs/whip#whipvideooptions)
...
* **Type**: [`WhipAudioOptions`](/ts-sdk/1.0/ts-sdk/outputs/whip#whipaudiooptions)
...
* **Type**: [`OutputEndCondition`](/ts-sdk/1.0/ts-sdk/outputs/whip#outputendcondition)
...
* **Type**: [`WhipVideoEncoderOptions`](/ts-sdk/1.0/ts-sdk/outputs/whip#whipvideoencoderoptions)
...
* **Type**: [`WhipAudioEncoderOptions`](/ts-sdk/1.0/ts-sdk/outputs/whip#whipaudioencoderoptions)

...
sidebar:
  order: 3
slug: ts-sdk/1.0/ts-sdk/outputs/rtp
---
...
* **Type**: [`RtpVideoOptions`](/ts-sdk/1.0/ts-sdk/outputs/rtp#rtpvideooptions)
...
* **Type**: [`RtpAudioOptions`](/ts-sdk/1.0/ts-sdk/outputs/rtp#rtpaudiooptions)
...
* **Type**: [`OutputEndCondition`](/ts-sdk/1.0/ts-sdk/outputs/rtp#outputendcondition)
...
* **Type**: [`RtpVideoEncoderOptions`](/ts-sdk/1.0/ts-sdk/outputs/rtp#rtpvideoencoderoptions)
...
* **Type**: [`RtpAudioEncoderOptions`](/ts-sdk/1.0/ts-sdk/outputs/rtp#rtpaudioencoderoptions)

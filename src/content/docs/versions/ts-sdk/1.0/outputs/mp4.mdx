...
* **Type**: [`OutputEndCondition`](/ts-sdk/1.0/ts-sdk/outputs/mp4#outputendcondition)
...
* **Type**: [`Mp4VideoEncoderOptions`](/ts-sdk/1.0/ts-sdk/outputs/mp4#mp4videoencoderoptions)
...
* **Type**: [`Mp4AudioEncoderOptions`](/ts-sdk/1.0/ts-sdk/outputs/mp4#mp4audioencoderoptions)

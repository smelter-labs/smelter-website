...
In this guide, you will learn how to implement basic animated transitions to the [`View`](/ts-sdk/1.0/components/view) and [`Rescaler`](/ts-sdk/1.0/components/rescaler) components.

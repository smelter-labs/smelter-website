...
<Aside>
  ...
  `shaderId` using the
  [`Smelter.registerShader`](/ts-sdk/1.0/ts-sdk/smelter#registershader) function.
</Aside>
...
ID of a shader. It identifies a shader registered using a [Smelter.registerShader](/ts-sdk/1.0/ts-sdk/smelter#registershader) method.

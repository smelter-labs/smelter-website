---
title: Tiles
slug: ts-sdk/1.0/ts-sdk/components/tiles
---
...
* **Type**: [`TilesStyleProps`](/ts-sdk/1.0/ts-sdk/props/tiles-style-props)
...
* **Type**: [`Transition`](/ts-sdk/1.0/ts-sdk/props/transition)

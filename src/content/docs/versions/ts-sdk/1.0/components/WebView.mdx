---
title: WebView
slug: ts-sdk/1.0/ts-sdk/components/webview
---
...
ID of a web renderer instance. It identifies an instance registered using a [Smelter.registerWebRenderer](/ts-sdk/1.0/ts-sdk/smelter#registerwebrenderer) method.

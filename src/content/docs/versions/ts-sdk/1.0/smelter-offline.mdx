...
It has simplified API compared to the [`Smelter`](/ts-sdk/1.0/ts-sdk/smelter) class, optimized for rendering just one output file as a result.
...
* [`LocallySpawnedInstnaceManager`](/ts-sdk/1.0/ts-sdk/managers/node-locally-spawned) (**Default Configuration**) - Automatically download the necessary Smelter binaries and launch the server on your local machine.

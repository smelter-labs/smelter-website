---
title: Smelter
slug: ts-sdk/0.3.x/ts-sdk/smelter
---
...
* [`LocallySpawnedInstnaceManager`](/ts-sdk/0.3.x/managers/node-locally-spawned) (**default**) - Automatically download the necessary Smelter binaries and launch the server on your local machine.
...
* **Type**: [`SmelterManager`](/ts-sdk/0.3.x/smelter#runtime-nodejs)
...
See [WebWasmSmelterOptions](/ts-sdk/0.3.x/managers/web-wasm/#webwasmsmelteroptions) to learn more.

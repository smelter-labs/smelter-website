---
title: WebRenderer
slug: ts-sdk/0.3.x/ts-sdk/resources/web-renderer
---
...
Represents an instance of a website rendered using Chromium embedded in the Smelter instance. It is utilized by a [WebView](/ts-sdk/0.3.x/components/webview) component.

<Aside>
  You need to enable `SMELTER_WEB_RENDERER_ENABLE` environment variable to use web rendering
  capabilities and Smelter binary needs to be build with web rendering support.
</Aside>

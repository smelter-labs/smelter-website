...
sidebar:
  order: 1
slug: ts-sdk/0.3.x/ts-sdk/web-client/smelter-offline
---
...
together. It has simplified API compared to the [`Smelter`](/ts-sdk/0.3.x/web-client/smelter) class, optimized for

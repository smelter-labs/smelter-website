---
title: View
slug: ts-sdk/0.3.x/ts-sdk/components/view
---
...
<Aside type="caution">The parent `View` doesn't respect the size of its children, so it will not be expanded by default. To learn more, visit the [Layout docs](/fundamentals/concepts/layouts/).</Aside>
...
* **Type**: [`ViewStyleProps`](/ts-sdk/0.3.x/components/props/view-style-props)
...
* **Type**: [`Transition`](/ts-sdk/0.3.x/components/props/transition)

---
title: InputStream
slug: ts-sdk/0.3.x/ts-sdk/components/inputstream
---
...
<Aside>
  To use this component, you need to first register the input with a matching `inputId` using the `Smelter.registerInput` function.
</Aside>

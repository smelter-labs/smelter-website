---
title: Tiles
slug: ts-sdk/0.3.x/ts-sdk/components/tiles
---
...
<Code code={tilesExample} title="TilesExample.tsx" lang="tsx" collapse={["28-45", "50-88"]} />
...
* **Type**: [`TilesStyleProps`](/ts-sdk/0.3.x/components/props/tiles-style-props)

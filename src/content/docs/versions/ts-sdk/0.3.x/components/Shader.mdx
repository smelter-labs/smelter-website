---
title: Shader
slug: ts-sdk/0.3.x/ts-sdk/components/shader
---
...
<Aside>
  To use this component, you need to first register the image with a matching `shaderId` using the `Smelter.registerShader` function.
</Aside>

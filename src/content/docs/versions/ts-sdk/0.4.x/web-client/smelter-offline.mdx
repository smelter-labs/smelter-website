...
sidebar:
  order: 1
slug: ts-sdk/0.4.x/ts-sdk/web-client/smelter-offline
---
...
together. It has simplified API compared to the [`Smelter`](/ts-sdk/0.4.x/web-client/smelter) class, optimized for

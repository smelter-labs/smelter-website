...
sidebar:
  order: 0
slug: ts-sdk/0.4.x/ts-sdk/web-client/overview
---
...
* [Live processing](/fundamentals/glossary#live-processing)
  ...
  Check out [`Smelter` documentation](/ts-sdk/0.4.x/web-client/smelter).
...
* [Offline processing](/fundamentals/glossary#offline-processing)
  ...
  Check out [`OfflineSmelter` documentation](/ts-sdk/0.4.x/web-client/smelter-offline).

...
sidebar:
  order: 2
slug: ts-sdk/0.4.x/ts-sdk/nodejs/smelter-offline
---
...
together. It has simplified API compared to the [`Smelter`](/ts-sdk/0.4.x/nodejs/smelter) class, optimized for
...
<Aside type="note">
  [WHIP](/ts-sdk/0.4.x/outputs/whip), [WHEP](/ts-sdk/0.4.x/outputs/whep), [RTMP](/ts-sdk/0.4.x/outputs/rtmp) and
  [RTP](/ts-sdk/0.4.x/outputs/rtp) are also supported. However, the Smelter produces frames as fast as
...
<Aside type="note">
  [WHIP](/ts-sdk/0.4.x/inputs/whip), [WHEP](/ts-sdk/0.4.x/inputs/whep), [RTMP](/ts-sdk/0.4.x/inputs/rtmp) and
  [RTP](/ts-sdk/0.4.x/inputs/rtp) are also supported. However, the Smelter produces frames as fast as possible

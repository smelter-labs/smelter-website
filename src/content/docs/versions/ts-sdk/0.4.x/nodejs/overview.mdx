...
sidebar:
  order: 0
slug: ts-sdk/0.4.x/ts-sdk/nodejs/overview
---
...
* [Live processing](/fundamentals/glossary#live-processing)
  ...
  Check out [`Smelter` documentation](/ts-sdk/0.4.x/nodejs/smelter).
...
* [Offline processing](/fundamentals/glossary#offline-processing)
  ...
  Check out [`OfflineSmelter` documentation](/ts-sdk/0.4.x/nodejs/smelter-offline).
...
`@swmansion/smelter-node` controls the Smelter server via [`SmelterManager`](/ts-sdk/0.4.x/nodejs/manager)
...
* [`LocallySpawnedInstanceManager`](/ts-sdk/0.4.x/nodejs/manager#locallyspawnedinstancemanager) (default) - downloads
  spawns Smelter binary and spawns a server locally.
* [`ExistingInstanceOptions`](/ts-sdk/0.4.x/nodejs/manager#existinginstancemanager) - connects to existing
  instance.

---
title: View
slug: ts-sdk/0.4.x/ts-sdk/components/view
---
...
* **Type**: [`ViewStyleProps`](/ts-sdk/0.4.x/components/props/view-style-props)
...
* **Type**: [`Transition`](/ts-sdk/0.4.x/components/props/transition)

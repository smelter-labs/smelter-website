---
title: WHIP server
slug: ts-sdk/0.4.x/ts-sdk/inputs/whip
---
...
<Aside type="tip">
  ...
  [WHIP streamer](https://smelter-labs.github.io/tools/#whip-streamer?url=http://localhost:9000/whip/example) —
  set `url` to your endpoint and append `&token=<bearerToken>` when the input requires one.
</Aside>

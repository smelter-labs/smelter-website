---
title: WHEP server
slug: ts-sdk/0.4.x/ts-sdk/outputs/whep
---
...
<Aside type="tip">
  ...
  [WHEP player](https://smelter-labs.github.io/tools/#whep-player?url=http://localhost:9000/whep/example) —
  set `url` to your endpoint and append `&token=<bearerToken>` when the output requires one.
</Aside>
...
* [FFmpeg H264](/ts-sdk/0.4.x/outputs/encoders/ffmpeg-h264)
* [FFmpeg VP8](/ts-sdk/0.4.x/outputs/encoders/ffmpeg-vp8)
* [FFmpeg VP9](/ts-sdk/0.4.x/outputs/encoders/ffmpeg-vp9)
* [Vulkan H264](/ts-sdk/0.4.x/outputs/encoders/vulkan-h264)
...
* [Opus](/ts-sdk/0.4.x/outputs/encoders/opus)

...
sidebar:
  order: 0
slug: ts-sdk/0.4.x/ts-sdk/guides/quick-start
---
...
<Steps>
  ...
  3. Register 2 input streams.
     ...
     logic would apply for any other [input type](/ts-sdk/0.4.x/overview#inputs).
  ...
  5. Modify the `<App/>` component to display both inputs.
     ...
     [`Tiles`](/ts-sdk/0.4.x/components/tiles) component is a simple way to display element in

...
slug: ts-sdk/0.2.x/ts-sdk/managers/node-locally-spawned
---
...
<Code
  title="LocallySpawnedInstanceManagerExample.tsx"
  code={`
...
* For temporary downloads. See [`SMELTER_DOWNLOAD_DIR`](/ts-sdk/0.2.x/deployment/configuration#smelter_download_dir).
...
* It configures [`SMELTER_WEB_RENDERER_ENABLE`](/ts-sdk/0.2.x/deployment/configuration#smelter_web_renderer_enable) environment variable.

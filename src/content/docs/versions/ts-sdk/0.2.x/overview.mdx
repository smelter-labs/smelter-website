...
Visit [`Smelter` class documentation](/ts-sdk/0.2.x/smelter) for more details, or for [offline processing](/fundamentals/glossary#offline-processing) checkout [`OfflineSmelter` class](/ts-sdk/0.2.x/smelter-offline).

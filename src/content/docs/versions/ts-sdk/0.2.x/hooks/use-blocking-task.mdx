...
slug: ts-sdk/0.2.x/ts-sdk/hooks/use-blocking-task
---
...
For [offline processing](/ts-sdk/0.2.x/fundamentals/glossary#offline-processing), it will additionally block processing until that Promise resolves. As long

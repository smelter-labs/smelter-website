...
sidebar:
  order: 1
slug: ts-sdk/0.2.x/ts-sdk/inputs/whip
---
...
configured with [`SMELTER_WHIP_WHEP_SERVER_PORT`](/ts-sdk/0.2.x/deployment/configuration#smelter_whip_whep_server_port).

To connect new input, register it first with [`Smelter.registerInput`](/ts-sdk/0.2.x/smelter#registerinput) and
...
* **Type**: [`InputWhipVideoOptions`](/ts-sdk/0.2.x/inputs/whip#inputwhipvideooptions)
...
* **Type**: [`InputWhipAudioOptions`](/ts-sdk/0.2.x/inputs/whip#inputwhipaudiooptions)

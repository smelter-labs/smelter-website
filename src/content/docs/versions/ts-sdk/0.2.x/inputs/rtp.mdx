...
sidebar:
  order: 3
slug: ts-sdk/0.2.x/ts-sdk/inputs/rtp
---
...
range will be returned from [`registerInput`](/ts-sdk/0.2.x/smelter#registerinput).
...
* **Type**: [`InputRtpVideoOptions`](/ts-sdk/0.2.x/inputs/rtp#inputrtpvideooptions)
...
* **Type**: [`InputRtpAudioOptions`](/ts-sdk/0.2.x/inputs/rtp#inputrtpaudiooptions)

---
title: WebRenderer
slug: ts-sdk/0.2.x/ts-sdk/resources/web-renderer
---
...
Represents an instance of a website rendered using Chromium embedded in the Smelter instance. It is utilized by a [WebView](/ts-sdk/0.2.x/components/webview) component.

...
* **[`SMELTER_WEB_RENDERER_ENABLE`](/ts-sdk/0.2.x/deployment/configuration#smelter_web_renderer_enable)** - For deployment, this environment variable must be set to `true` to enable the web renderer functionality.

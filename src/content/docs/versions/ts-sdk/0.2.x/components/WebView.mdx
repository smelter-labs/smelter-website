---
title: WebView
slug: ts-sdk/0.2.x/ts-sdk/components/webview
---
...
ID of a web renderer instance. It identifies an instance registered using a [Smelter.registerWebRenderer](/ts-sdk/0.2.x/smelter#registerwebrenderer) method.

---
title: Shader
slug: ts-sdk/0.2.x/ts-sdk/components/shader
---
...
For more information on using shaders in Smelter, please visit [Shaders documentation](/ts-sdk/0.2.x/fundamentals/concepts/shaders).

<Aside>
  To use this component, you need to first register the image with a matching
  `shaderId` using the
  [`Smelter.registerShader`](/ts-sdk/0.2.x/smelter#registershader) function.
</Aside>
...
ID of a shader. It identifies a shader registered using a [Smelter.registerShader](/ts-sdk/0.2.x/smelter#registershader) method.

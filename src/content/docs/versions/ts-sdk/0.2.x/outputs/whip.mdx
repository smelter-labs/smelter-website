...
sidebar:
  order: 1
slug: ts-sdk/0.2.x/ts-sdk/outputs/whip
---
...
* **Type**: [`WhipVideoOptions`](/ts-sdk/0.2.x/outputs/whip#whipvideooptions)
...
* **Type**: [`WhipAudioOptions`](/ts-sdk/0.2.x/outputs/whip#whipaudiooptions)
...
* **Type**: [`OutputEndCondition`](/ts-sdk/0.2.x/outputs/whip#outputendcondition)
...
* **Type**: [`WhipVideoEncoderOptions`](/ts-sdk/0.2.x/outputs/whip#whipvideoencoderoptions)
...
* **Type**: [`WhipAudioEncoderOptions`](/ts-sdk/0.2.x/outputs/whip#whipaudioencoderoptions)

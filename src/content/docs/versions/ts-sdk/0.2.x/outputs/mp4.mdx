...
sidebar:
  order: 2
slug: ts-sdk/0.2.x/ts-sdk/outputs/mp4
---
...
* **Type**: [`OutputEndCondition`](/ts-sdk/0.2.x/outputs/mp4#outputendcondition)
...
* **Type**: [`Mp4VideoEncoderOptions`](/ts-sdk/0.2.x/outputs/mp4#mp4videoencoderoptions)
...
* **Type**: [`Mp4AudioEncoderOptions`](/ts-sdk/0.2.x/outputs/mp4#mp4audioencoderoptions)

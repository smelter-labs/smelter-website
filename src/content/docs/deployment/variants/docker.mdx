...
- [`tools/docker/slim.Dockerfile`](https://github.com/software-mansion/smelter/blob/master/tools/docker/slim.Dockerfile) - Base version
- [`tools/docker/full.Dockerfile`](https://github.com/software-mansion/smelter/blob/master/tools/docker/full.Dockerfile) - Smelter version with web rendering enabled. Includes Chromium Embedded Framework.

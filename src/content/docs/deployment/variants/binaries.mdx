...
For Linux:
- FFmpeg 6.0 or higher, version 6.1 recommended.
...
For macOS:
- `aarch64`: FFmpeg 6.0 or higher, version 8.0 recommended.
- `x86_64`: FFmpeg 8.0 required.

<Aside>
If recommended version is not present, appropriate `libav` dependencies will be pulled by Smelter,
except for `darwin_x86_64` version.
</Aside>

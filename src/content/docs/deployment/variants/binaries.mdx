...
<Aside>
If required FFmpeg version is not present, appropriate `libav` dependencies will be pulled by Smelter,
except for `darwin_x86_64` version. Downloaded libraries require to have dependencies of FFmpeg
installed.
</Aside>

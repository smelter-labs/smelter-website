...
See [their documentation](https://github.com/chromiumembedded/cef) for details or our Dockerfile ([`tools/docker/full.Dockerfile`](https://github.com/software-mansion/smelter/blob/master/tools/docker/full.Dockerfile)).

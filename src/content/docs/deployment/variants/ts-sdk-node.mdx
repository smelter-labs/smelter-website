...
Alternatively, you can point SDK to server you started yourself. See
[`ExistingInstanceManager`](/ts-sdk/nodejs/manager/#existinginstancemanager) to configure it. For instructions
how to start the server itself check out documentation for [docker deployment](/deployment/variants/docker)

...
<Aside type="caution">This option does not apply to: <ul><li>Logs produced by FFmpeg</li><li>The embedded Chromium instance used for web rendering</li></ul></Aside>
...
<Aside type="caution">With this option disabled, you can not use `WebView` components or register `WebRenderer` instances.</Aside>

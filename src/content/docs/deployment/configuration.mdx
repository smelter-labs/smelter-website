...
```
- **Supported values**:
    - `string` containing comma-separated list of WebGPU features (see <a href="https://docs.rs/wgpu/22.1.0/wgpu/struct.Features.html" target='_blank'>Rust WebGPU documentation</a> for the list of available options)

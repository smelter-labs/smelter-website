...
You can see the most important benchmarks below. Visit our [GitHub repository](https://github.com/software-mansion/smelter/tree/master/integration_tests/benchmarks) for more results and the exact implementation of the benchmarks.

### `g4dn.xlarge`

**4vCPU 16GB, GPU Nvidia T4**

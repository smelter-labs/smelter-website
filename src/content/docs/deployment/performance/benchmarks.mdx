...
<Aside type="caution">
This data was calculated based on Smelter v0.4.0, before hardware encoders were added. 
Performance for scenarios described below should still be similar on latest version. However,
the most optimal cases, where everything runs on GPU, are not described here yet.
</Aside>

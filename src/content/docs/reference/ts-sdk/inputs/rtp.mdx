...
Specifies whether the stream uses forward error correction. It's specific for the `Opus` codec. For more information, visit [RFC specification](https://datatracker.ietf.org/doc/html/rfc6716#section-2.1.7).
...
#### audioSpecificConfig
Configuration encoded in the format described in [RFC 3640](https://datatracker.ietf.org/doc/html/rfc3640#section-4.1).
...
#### rtpMode
Specifies the RFC 3640 mode that should be used when depacketizing this stream. For more information, visit [RFC specification](https://datatracker.ietf.org/doc/html/rfc3640#section-3.3.1)

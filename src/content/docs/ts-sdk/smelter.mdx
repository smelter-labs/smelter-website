...
- [WHIP](/ts-sdk/outputs/wasm-whip)
- [canvas](/ts-sdk/outputs/wasm-canvas)
- [stream](/ts-sdk/outputs/wasm-stream)
...
`@swmansion/smelter-web-wasm`
- [Camera](/ts-sdk/inputs/wasm-camera)
- [Screen capture](/ts-sdk/inputs/wasm-screen)
- [MediaStream](/ts-sdk/inputs/wasm-stream)
- [MP4](/ts-sdk/inputs/mp4)

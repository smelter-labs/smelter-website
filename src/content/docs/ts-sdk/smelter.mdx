...
It is available in 3 variants for different runtimes:
<Tabs syncKey="smelter-variants">
  <TabItem label="Node">
    <Code code={`import Smelter from "@swmansion/smelter-node"`} lang="tsx" />
  </TabItem>
  <TabItem label="Browser (Node)">
    <Code code={`import Smelter from "@swmansion/smelter-web-wasm"`} lang="tsx" />
  </TabItem>
  <TabItem label="Browser (Client)">
    <Code code={`import Smelter from "@swmansion/smelter-web-client"`} lang="tsx" />
  </TabItem>
</Tabs>
...
<Code code={`new Smelter(options: SmelterInstanceOptions)`} lang="tsx" />
<CollapsibleDetails summaryTitle='Type definitions'>
<Code code={`
...
See [SmelterInstanceOptions](/ts-sdk/managers/web-client#smelterinstanceoptions) to learn more.
...
`@swmansion/smelter-node` and `@swmansion/smelter-web-client`

...
<Code
  code={`Smelter.unregisterOutput(outputId: string): Promise<void>`}
  lang="tsx"
/>
...
<Code
  code={`Smelter.unregisterInput(inputId: string): Promise<void>`}
  lang="tsx"
/>
...
<Code
  code={`Smelter.unregisterImage(imageId: string): Promise<void>`}
  lang="tsx"
/>
...
<Code
  code={`Smelter.unregisterShader(shaderId: string): Promise<void>`}
  lang="tsx"
/>
...
<Code
  code={`Smelter.unregisterWebRenderer(instanceId: string): Promise<void>`}
  lang="tsx"
/>
...
<Code
  code={`Smelter.registerFont(source: FontSource): Promise<void>`}
  lang="tsx"
/>

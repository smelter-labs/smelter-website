...
#### fontWeight
Specifies the weight of the font, as defined in the [OpenType specification](https://learn.microsoft.com/en-gb/typography/opentype/spec/os2#usweightclass). Ensure the selected font supports this weight.

...
<Aside>To use this component, you need to first register the image with a matching `inputId` using the [`Smelter.registerInput`](/ts-sdk/live-compositor#registerinput) function.</Aside>

...
<Aside>To use this component, you need to first register the image with a matching `shaderId` using the [`Smelter.registerShader`](/ts-sdk/live-compositor#registershader) function.</Aside>
...
### shaderId
ID of a shader. It identifies a shader registered using a [Smelter.registerShader](/ts-sdk/live-compositor#registershader) method.

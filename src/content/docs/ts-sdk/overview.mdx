...
Visit [`Smelter` class documentation](/ts-sdk/smelter) for more details, or for [offline processing](/fundamentals/glossary#offline-processing) check out [`OfflineSmelter` class](/ts-sdk/smelter-offline).

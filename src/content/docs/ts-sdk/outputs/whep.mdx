...
type RegisterWhepServerOutput = {
  type: "whep_server";
  bearerToken?: string;
  video?: WhepServerVideoOptions;
  audio?: WhepServerAudioOptions;
}
```
</CollapsibleDetails>
...
- **Type**: [`WhepServerVideoOptions`](#whepservervideooptions)
...
- **Type**: [`WhepServerAudioOptions`](#whepserveraudiooptions)

## WhepServerVideoOptions

<CollapsibleDetails summaryTitle='Type definitions' open>
```tsx
type WhepServerVideoOptions = {
    resolution: {
      width: number;
      height: number;
    };
...
- **Type**: [`WhepServerVideoEncoderOptions`](#whepservervideoencoderoptions)


## WhepServerVideoEncoderOptions

<CollapsibleDetails summaryTitle='Type definitions' open>
```tsx
type WhepServerVideoEncoderOptions = 
  | {
      type: "ffmpeg_h264";
      preset?: 
        | "ultrafast"
...
## WhepServerAudioOptions

<CollapsibleDetails summaryTitle='Type definitions' open>
```tsx
type WhepServerAudioOptions = {
...
- **Type**: [`WhepServerAudioEncoderOptions`](#whepserveraudioencoderoptions)

## WhepServerAudioEncoderOptions

<CollapsibleDetails summaryTitle='Type definitions' open>
```tsx
type WhepServerAudioEncoderOptions = {
    type: "opus";

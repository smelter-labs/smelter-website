...
## RegisterWhipOutput
<Code code={`import { Outputs, RegisterWhipOutput } from "@swmansion/smelter"`} lang='tsx' />
...
- **Type**: [`Outputs.OutputWhipVideoOptions`](/ts-sdk/outputs/whip#outputsoutputwhipvideooptions)
...
- **Type**: [`Outputs.OutputWhipAudioOptions`](/ts-sdk/outputs/whip#outputswhipaudiooptions)
...
- **Type**: [`Outputs.OutputEndCondition`](/ts-sdk/outputs/whip#outputsoutputendcondition)
...
- **Type**: [`Outputs.WhipVideoEncoderOptions`](/ts-sdk/outputs/whip#outputswhipvideoencoderoptions)
...
- **Type**: [`Outputs.WhipAudioEncoderOptions`](/ts-sdk/outputs/whip#outputswhipaudioencoderoptions)

...
**add more details** An output type that allows streaming video and audio from the compositor over WHIP.

<Code code={`import { Outputs } from "live-compositor"`} lang='tsx' />

## Outputs.RegisterWhipOutput
Parameters for an WHIP output stream from the compositor.
...
#### sampleRate
Sample rate. Allowed values: [8000, 16000, 24000, 48000].

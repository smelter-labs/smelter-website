...
An output that lets you connect to a WHIP server endpoint to streaming video and audio to it.
...
type RegisterWhipClientOutput = {
  ...
  endpointUrl: string;
  bearerToken?: string;
  video?: WhipClientVideoOptions;
  audio?: true | WhipClientAudioOptions;
};
```
</CollapsibleDetails>
...
- **Type**: [`WhipClientVideoOptions`](#whipclientvideooptions)
...
When set to `true`, audio will be enabled without requiring explicit `WhipClientAudioOptions` - they will be set automaticly based on negotation.

- **Type**: `true` | [`WhipClientAudioOptions`](#whipclientaudiooptions)

## WhipClientVideoOptions

<CollapsibleDetails summaryTitle='Type definitions' open>

```tsx
type WhipClientVideoOptions = {
  resolution: {
    width: number;
    height: number;
  };
  sendEosWhen?: OutputEndCondition;
  encoderPreferences?: WhipClientVideoEncoderOptions[];
};
```
</CollapsibleDetails>
...
- **Type**: [`WhipClientVideoEncoderOptions`](#whipclientvideoencoderoptions)[]
...
## WhipClientVideoEncoderOptions

<CollapsibleDetails summaryTitle='Type definitions' open>
```tsx
type WhipClientVideoEncoderOptions =
  | {
      type: "ffmpeg_h264";
      preset?:
        | "ultrafast"
...
## WhipClientAudioOptions

<CollapsibleDetails summaryTitle='Type definitions' open>
```tsx
type WhipClientAudioOptions = {
  channels?: "mono" | "stereo";
  mixingStrategy?: "sum_clip" | "sum_scale";
  sendEosWhen?: OutputEndCondition;
  encoderPreferences?: WhipClientAudioEncoderOptions[];
}
```
</CollapsibleDetails>
...
- **Type**: [`WhipClientAudioEncoderOptions`](#whipclientaudioencoderoptions)[]
- **Default value**: `[{ type: "any" }]`
...
## WhipClientAudioEncoderOptions

<CollapsibleDetails summaryTitle='Type definitions' open>
```tsx
type WhipClientAudioEncoderOptions = {
  type: "opus";

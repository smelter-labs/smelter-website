...
- **Type**: [`HlsVideoOptions`](#hlsvideooptions)
...
- **Type**: [`HlsAudioOptions`](#hlsaudiooptions)

## HlsVideoOptions

<CollapsibleDetails summaryTitle='Type definitions' open>
```tsx
type HlsVideoOptions = {
  resolution: {
    width: number;
    height: number;
  };
...
- **Type**: [`OutputEndCondition`](/ts-sdk/outputs/hls#outputendcondition)
...
- **Type**: [`HlsVideoEncoderOptions`](/ts-sdk/outputs/hls#hlsvideoencoderoptions)
...
- **Type**: [`HlsAudioEncoderOptions`](/ts-sdk/outputs/hls#hlsaudioencoderoptions)

## HlsAudioEncoderOptions

<CollapsibleDetails summaryTitle='Type definitions' open>
```tsx
type HlsAudioEncoderOptions = {
  type: "aac";
  sampleRate?: number;
}
```

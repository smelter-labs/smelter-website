...
### startAtMs
Time in milliseconds when this output should start producing data. Value `0` represents time of the
[`start()`](/ts-sdk/nodejs/smelter#start) call. Output is always created when it is registered

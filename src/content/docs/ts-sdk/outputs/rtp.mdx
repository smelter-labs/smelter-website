...
#### expectedPacketLoss
Expected packet loss percentage. When forward error correction is enabled this value should be greater than 0. Higher values trigger more loss resistant behavior at the expense of quality.

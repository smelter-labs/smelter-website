...
Configures whether the encoder includes forward error correction frames in audio chunks. For more information, visit RFC specification sections [2.1.7](https://datatracker.ietf.org/doc/html/rfc6716#section-2.1.7)
...
#### expectedPacketLoss
Expected packet loss percentage. When forward error correction is enabled this value should be greater than 0. Higher values trigger more loss resistant behavior at the expense
of quality at given bitrate in the absence of packet loss, but with greater quality under loss.

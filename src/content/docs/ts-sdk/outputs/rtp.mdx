...
Specifies whether the stream uses forward error correction. It’s specific for the `Opus` codec. For more information, visit RFC specification sections [2.1.7](https://datatracker.ietf.org/doc/html/rfc6716#section-2.1.7)
...
#### expectedPacketLoss
Expected approximate packet loss percentage. When forward error correction is enabled this value should be greater than 0.

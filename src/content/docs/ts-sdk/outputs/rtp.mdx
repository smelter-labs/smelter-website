...
Configures whether the encoder includes forward error correction bits in audio chunk. For more information, visit RFC specification sections [2.1.7](https://datatracker.ietf.org/doc/html/rfc6716#section-2.1.7)

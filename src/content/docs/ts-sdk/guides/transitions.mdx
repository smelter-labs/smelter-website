...
import WidthTransitionImage from '../../../../assets/guides/transitions-width.webp'
import SiblingTransitionImage from '../../../../assets/guides/transitions-sibling-width.webp'
import InterpolationFunctionsTransitionImage from '../../../../assets/guides/transitions-interpolation-functions.webp'
...
<img src={WidthTransitionImage.src} alt="Rescaler transition result" />
...
<img src={SiblingTransitionImage.src} alt="Rescaler transition result" />
...
<img src={InterpolationFunctionsTransitionImage.src} alt="Rescaler transition result" />

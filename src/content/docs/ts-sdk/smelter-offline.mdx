...
- **Type**: [`SmelterManager`](/ts-sdk/smelter#swmnasionsmelter-node)
...
<Aside type="caution">
Remember that in this mode compositor will produce frames as fast as possible. Protocols like RTP or WHIP
can technically be used as output, but in most cases it would not make sense.
</Aside>
...
Register an image asset. See [Renderers.RegisterImage](/ts-sdk/resources/image/#renderersregisterimage) to learn more.
...
Register a shader. See [Renderers.RegisterShader](/ts-sdk/resources/shader#renderersregistershader) to learn more.

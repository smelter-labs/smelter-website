...
Deploy the Smelter binary or a Docker image and communicate with the server via HTTP API using
the language of your choice.

This is the most flexible option, however it comes at the cost of quality-of-life features
that other frameworks deliver.
...
Check out this [example Vite project](https://github.com/smelter-labs/examples/tree/main/web-client-vite) to get started.
...
[example Vite project](https://github.com/smelter-labs/examples/tree/main/web-wasm-vite) 
to get started.

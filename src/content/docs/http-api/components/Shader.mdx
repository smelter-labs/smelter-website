...
<CollapsibleDetails summaryTitle='Register image on which the shader will be applied' open>
```http
...
{
  "asset_type": "svg",
  "url": "https://mywebsite.com/example.svg"
}
```
</CollapsibleDetails>

Now, update an output stream where the shader-processed image will be streamed.

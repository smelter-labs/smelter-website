...
<CollapsibleDetails summaryTitle='Register RTP output with Tiles component' open>
<Code code={`
...
`} lang='http' ins={{range: '19-34'}} />
</CollapsibleDetails>

After sending [start request](/http-api/routes#start-request) you will see output displaying three rectangles(green, red and blue) arranged by a Tiles component, streamed on port 8004.

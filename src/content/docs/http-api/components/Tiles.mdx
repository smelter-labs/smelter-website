...
Below is an example demonstrating how the Tiles component arranges input streams in the output stream. Note that all inputs had been previously registered.

<CollapsibleDetails summaryTitle='Update output 1' open>
```http 
...
<CollapsibleDetails summaryTitle='Update output 2'>
```http
POST: /api/output/example_output/update
Content-Type: application/json
...
<CollapsibleDetails summaryTitle='Update output 3'>
```http
POST: /api/output/example_output/update
Content-Type: application/json
...
<CollapsibleDetails summaryTitle='Update output 4'>
```http
POST: /api/output/example_output/update
Content-Type: application/json
...
<CollapsibleDetails summaryTitle='Update output 5'>
```http 
POST: /api/output/example_output/update
Content-Type: application/json

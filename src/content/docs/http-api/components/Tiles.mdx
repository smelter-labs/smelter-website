...
Below is an example demonstrating how the Tiles component arranges three input streams in the output stream. Note that all inputs had been previously registered.

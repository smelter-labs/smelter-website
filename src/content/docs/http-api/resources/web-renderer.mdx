...
Represents an instance of a website rendered using Chromium embedded in the Smelter. It is utilized by a [WebView](/http-api/components/webview) component. Ensure that the Smelter supports web rendering before utilizing the web renderer.

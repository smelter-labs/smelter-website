...
type WhipClient = {
  ...
  endpoint_url: string;
  bearer_token?: string;
  video?: OutputWhipClientVideoOptions;
  audio?: OutputWhipClientAudioOptions;
};
```
</CollapsibleDetails>
...
- **Type**: [`OutputWhipClientVideoOptions`](#outputwhipclientvideooptions)
...
- **Type**: [`OutputWhipClientAudioOptions`](#outputwhipclientaudiooptions)

## OutputWhipClientVideoOptions
Parameters of a video source included in the WHIP stream.

<CollapsibleDetails summaryTitle='Type definitions' open>
```tsx
type OutputWhipClientVideoOptions = {
  resolution: {
    width: u32;
    height: u32;
  };
  send_eos_when?: OutputEndCondition;
  encoder_preferences?: WhipClientVideoEncoderOptions[];
...
## OutputWhipClientAudioOptions
Parameters of an audio source included in the WHIP stream.

<CollapsibleDetails summaryTitle='Type definitions' open>
```tsx
type OutputWhipClientAudioOptions = {
  mixing_strategy?: "sum_clip" | "sum_scale";
  send_eos_when?: OutputEndCondition;
  encoder_preferences?: WhipClientAudioEncoderOptions[];

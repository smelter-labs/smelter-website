...
- **Supported values**:
  ...
  - `low_latency_quality` - prioritizing quality, tuned for low latency streaming
  - `low_latency_balanced` - compromise between speed and quality, tuned for low latency streaming
  - `low_latency_fast` - prioritizing speed, tuned for low latency streaming

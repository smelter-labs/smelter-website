...
#### bitrate
Bitrate of the output stream, in kb/s.
...
#### bitrate
Bitrate of the output stream, in b/s.
...
Bitrate measured in bits/second. If only the `number` is specified it is treated as average bitrate

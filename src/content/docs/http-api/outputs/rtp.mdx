...
- **Type**: `u32`
- **Default value**: TODO: (@jbrs) It is encoder based. The *one that shall not be named* just uses crf mode with default of 23,
                     openh264 just sets it to 2000k
...
- **Type**: `u32`
- **Default value**: TODO: This is even worse case than h264

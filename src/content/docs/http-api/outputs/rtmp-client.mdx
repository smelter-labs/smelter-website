...
## Usage
To use RTMP output you must register it first. You can do it by sending a request like this:
...
Parameters for an RTMP output stream from Smelter.
...
- **Type**: [`RtmpClientVideoEncoderOptions`](#whipvideoencoderoptions)
...
- **Type**: [`RtmpClientAudioEncoderOptions`](#whipaudioencoderoptions)

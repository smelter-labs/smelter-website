...
type WhepServer = {
  type: "whep_server";
  bearer_token?: string;
  video?: OutputWhepServerVideoOptions;
  audio?: OutputWhepServerAudioOptions;
}
```
</CollapsibleDetails>
...
- **Type**: [`OutputWhepServerVideoOptions`](#outputwhepservervideooptions)
...
- **Type**: [`OutputWhepServerAudioOptions`](#outputwhepserveraudiooptions)

## OutputWhepServerVideoOptions
<CollapsibleDetails summaryTitle='Type definitions' open>
```tsx
type OutputWhepServerVideoOptions = {
  resolution: {
    width: u32;
    height: u32;
  };
...
## OutputWhepServerAudioOptions

<CollapsibleDetails summaryTitle='Type definitions' open>
```tsx
type OutputWhepServerAudioOptions = {
